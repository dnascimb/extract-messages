...
## Project Overview
A Python script that exports iMessage conversations from macOS's local SQLite database (`~/Library/Messages/chat.db`) into HTML, JSON, and plain-text formats, with attachment copying.
...
- No third-party dependencies — only stdlib (`sqlite3`, `shutil`, `json`, `pathlib`, `argparse`)
